...
class TestPrepareMonthDayHeatmapData:
        ...
        feb_data = pd.DataFrame(
            {
                ...
                "period_end": pd.date_range(
                    "2023-02-01 00:15:00", periods=96, freq="15min"
                ),
        ...
        periods_df = pd.DataFrame(
            {
                ...
                "period_end": pd.date_range(
                    "2023-01-15 00:15:00", periods=96, freq="15min"
                ),
                "energy_kwh": [0.1] * 96,
            }
        )
    ...
    def test_data_aggregation_accuracy(self):
        ...
        periods_df = pd.DataFrame(
            {
                "period_start": pd.date_range(
                    "2023-01-01", periods=4, freq="15min"
                ),  # 1 hour
                "period_end": pd.date_range(
                    "2023-01-01 00:15:00", periods=4, freq="15min"
                ),
...
class TestPrepareDayColumnData:
    ...
    def test_missing_hours_filled_with_zero(self):
        ...
        periods_df = pd.DataFrame(
            {
                "period_start": pd.date_range(
                    "2023-01-01 12:00:00", periods=4, freq="15min"
                ),  # Hour 12 only
                "period_end": pd.date_range(
                    "2023-01-01 12:15:00", periods=4, freq="15min"
                ),
...
class TestPrepareDay15minHeatmapData:
    ...
    def test_basic_15min_matrix(self):
        ...
        periods_df = pd.DataFrame(
            {
                "period_start": pd.date_range(
                    "2023-01-01", periods=8, freq="15min"
                ),  # 2 hours on day 1
                "period_end": pd.date_range(
                    "2023-01-01 00:15:00", periods=8, freq="15min"
                ),
                "energy_kwh": [0.1] * 8,
            }
        )
        ...
        day2_data = pd.DataFrame(
            {
                "period_start": pd.date_range(
                    "2023-01-02", periods=8, freq="15min"
                ),  # 2 hours on day 2
                "period_end": pd.date_range(
                    "2023-01-02 00:15:00", periods=8, freq="15min"
                ),
                "energy_kwh": [0.2] * 8,
            }
        )

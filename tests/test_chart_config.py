...
class TestTimeSeriesLayout:
    ...
    def test_custom_parameters(self):
        ...
        result_fig = apply_time_series_layout(
            fig, height=500, showlegend=True, title=custom_title, compact=True
        )
...
class TestStandardAnnotation:
    ...
    def test_custom_parameters(self):
        ...
        annotation = create_standard_annotation(
            "Test", showarrow=True, bgcolor="yellow", custom_param="value"
        )
...
class TestHeatmapLayout:
    ...
    def test_default_heatmap(self):
        ...
        result_fig = apply_heatmap_layout(
            fig, title="Heatmap Test", xaxis_title="Hour", yaxis_title="Day"
        )
...
class TestViolinLayout:
    ...
    def test_custom_violin(self):
        ...
        result_fig = apply_violin_layout(
            fig, title=custom_title, height=600, yaxis_title="Values", showlegend=False
        )
...
class TestIntegration:
    ...
    def test_complete_chart_setup(self):
        ...
        fig = apply_time_series_layout(
            fig, title="Integration Test Chart", height=400, showlegend=True
        )

        # Apply standard axes
        fig = apply_standard_axes(fig, xaxis_title="Time", yaxis_title="Rainfall (in)")

        # Add annotation
        annotation = create_standard_annotation("Test Annotation", position="top_left")
    ...
    def test_subplot_with_multiple_configs(self):
        ...
        fig = apply_standard_axes(
            fig, xaxis_title="Time", yaxis_title="Rainfall", type_x="date"
        )
